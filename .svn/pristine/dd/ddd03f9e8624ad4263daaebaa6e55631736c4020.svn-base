<template>
  <div class="rolemanagerbox" id="rolemanagerbox">
        ...
        <div class="tablebox">
          ...
          <div class="eletable">
            <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="rolecode" label="角色编码" type="text" size="small" v-if="false" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog :title="poptitle" :visible.sync="dialogFormVisible">
      <el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm">
        <el-form-item label="角色编码" prop="rolecode" v-if="false">
...
export default {
  ...
  methods: {
    ...
    Checktreedata(data, checked, indeterminate) {
      if (this.$refs.treedata !== undefined) {
    ...
    Checktreemenu(data, checked, indeterminate) {
      let checkid = this.$refs.treemenu.getCheckedKeys().concat(this.$refs.treemenu.getHalfCheckedKeys());
    ...
    edit(row) {
      ...
      this.$nextTick(() => {
        if (this.ruleForm.menucode === '' || this.ruleForm.menucode === null) {
          this.$refs.treemenu.setCheckedKeys([]);
        } else {
        ...
        if (this.ruleForm.reportcode === '' || this.ruleForm.reportcode === null) {
          // this.$refs.treedata.setCheckedKeys([]);
        } else {
